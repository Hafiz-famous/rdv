@php($title = 'Créer un compte Infirmier')
<!doctype html>
<html lang="fr">
...
<form class="card p-4 shadow-sm bg-white" method="POST" action={{ route('register.infirmier') }}>@csrf
<div class="row g-3">
...
<div class="col-md-6"><label class="form-label">Service</label><input name="service" class="form-control"></div>
<div class="col-md-6"><label class="form-label">Pays</label><input name="pays" class="form-control"></div>
<div class="col-md-6"><label class="form-label">Ville</label><input name="ville" class="form-control"></div>
